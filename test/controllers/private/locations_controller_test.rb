...
module Private
  class LocationsControllerTest < ActionController::TestCase
    ...
    def test_list_endpoint_returns_proper_json
      ...
      location_1 = Location.create!(name: 'Location 1', secret_code: generate_code)
      location_2 = Location.create!(name: 'Location 2', secret_code: generate_code)
      location_3 = Location.create!(name: 'Location 3', secret_code: generate_code)
