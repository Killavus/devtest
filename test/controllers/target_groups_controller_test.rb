    ...
    assert_equal([
      {
        ...
        "nodes" => [
          {
            "id" => TargetGroup.find_by(name: 'Test').external_id,
            "name" => "Test",
            "parent_id" => nil
          },
          {
            "id" => TargetGroup.find_by(name: 'Test 2').external_id,
            "name" => "Test 2",
            "parent_id" => TargetGroup.find_by(name: 'Test').external_id
          },
          {
            "id" => TargetGroup.find_by(name: 'Test 3').external_id,
            "name" => "Test 3",
            "parent_id" => TargetGroup.find_by(name: 'Test 2').external_id
          }
        ]
      }
    ], json_body)
